# Dunstable and Leighton Buzzard — Leafletting Map

A canvassing and leafletting tracker for Dunstable and Leighton Buzzard (Westminster constituency, in full — 11 wards, all within Central Bedfordshire). Volunteers can view road-level status, plan routes, and mark progress in real time via a Google Sheets backend.
